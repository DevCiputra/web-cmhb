<?php $__env->startSection('title', 'Tambah Data Poliklinik Dokter'); ?>
    ...
    <div class='dashboard-content'>
                ...
                <div class="d-flex flex-column">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('doctor.polyclinic.index')); ?>">Daftar Poliklinik</a></li>
        ...
        <div class="card"
            ...
            <div class="card-form" style="padding: 2rem;">
                <!-- Form -->
                <form method="POST" action="<?php echo e(route('doctor.polyclinic.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('management-data.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-cmhb\resources\views/management-data/doctor/polyclinic/create.blade.php ENDPATH**/ ?>