...
<?php $__env->startSection('title', 'Home Service'); ?>
        ...
        <div class="card"
            ...
            <div class="card-form">
                <div class="d-flex mb-3">
                    <h4 class="card-title" style="color: #1C3A6B"><b>Data Home Service</b></h4>
                    <div class="ms-auto">
                        <a href="/tambah_homeservice" style="text-decoration: none;">
                ...
                <div class="d-flex mb-4">
                    <p class="card-text">Berikut merupakan tabel data pendaftaran paket Home Service.</p>
                </div>
                <div style="max-height: 550px; overflow-y: auto; width: 100%;">
                    <table class="table table-bordered" id="dataTableHomeService"
                        style="width: 100%; border-top: 1px solid grey;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nama Home Service</th>
                                <th>Deskripsi</th>
                                <th>URL</th>
                                <th>Aksi</th>
                            </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('management-data.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-cmhb\resources\views/management-data/reservation/home-service/index.blade.php ENDPATH**/ ?>