...
<body data-bs-spy="scroll" data-bs-target=".nav" data-bs-offset="50">
    <!-- Navbar Section -->
    @include('layouts.navbar_landingpage')
    <div class="container" style="margin-top: 80px;">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 hero-text">
                        ...
                        <div class="hero-buttons">
                            ...
                            <a href="/dokter" class="btn btn-outline-success btn-lg" style="border-radius: 30px;">Cari
                                Dokter</a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 doctor-text">
                        ...
                        <div class="doctor-buttons">
                            <a href="/dokter" class="btn btn-success btn-lg"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex flex-column">
                        <a href="/mcu" class="reservation-item mb-3" id="card-mcu">
                        ...
                        <a href="/homeservice" class="reservation-item mb-3" id="card-home-service">
                            <div class="reservation-content">
                    ...
                    <!-- Column 2 -->
                    <div class="col-md-7">
                        <a href="/poliklinik" class="reservation-item mb-3" id="card-poliklinik">
                            <div class="reservation-content">
        ...
        <div id="promotion" class="promotion-section">
            <div class="container-fluid">
                ...
                <a href="/promosi" class="btn btn-semua"
        ...
        <div id="info" class="info-section">
            <div class="container">
                ...
                <p style="margin-bottom: 15px;">Lorem ipsum dolor sit amet consectetur adipiscing elit semper dalar
                    elementum tempus hac tellus libero accumsan.</p>
                <a href="/informasi" class="btn btn-semua"
                    style="color:#023770; font-size: 1.2rem; margin-top: -10px; margin-bottom: 10px">
                    Lihat Semua
                    <img src="{{ asset('icons/chevron-right.png') }}" alt="Chevron Right" class="chevron-icon">
                </a>
