                ...
                <div class="card-form" style="padding: 2rem;">
                    <form action="{{ route('information.article.update', $article->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="flag" id="kategoriArtikel"
                                class="form-select @error('flag') is-invalid @enderror" required>
                                <option value="" disabled {{ old('flag', $article->flag) == '' ? 'selected' : '' }}>
                                    Pilih Kategori</option>
                                <option value="Artikel Kesehatan"
                                    {{ old('flag', $article->flag) == 'Artikel Kesehatan' ? 'selected' : '' }}>Artikel
                                    Kesehatan</option>
                                <option value="Tips Kesehatan"
                                    {{ old('flag', $article->flag) == 'Tips Kesehatan' ? 'selected' : '' }}>Tips Kesehatan
                                </option>
                                <option value="Event" {{ old('flag', $article->flag) == 'Event' ? 'selected' : '' }}>Event
                                </option>
                            </select>
                            @error('flag')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="deskripsiArtikel" type="hidden" name="description"
                                value="{{ old('description', $article->description) }}">
                            <trix-editor input="deskripsiArtikel" placeholder="Masukkan Deskripsi Artikel"></trix-editor>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('special_information') is-invalid @enderror"
                                id="special_information" name="special_information"
                                value="{{ old('special_information', $article->special_information) }}"
                                placeholder="Masukkan Informasi Khusus">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('image') is-invalid @enderror"
                                id="article_image" name="image" accept="image/*" onchange="previewNewImage(event)">
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="mt-3">
                                ...
                                @if ($article->media && $article->media->first())
                                    <img id="original_image_preview"
                                        ...
                                        alt="Original Article Image" class="img-fluid" width="150"
                            ...
                            <div class="mt-3">
                                ...
                                <img id="new_image_preview" src="#" alt="New Article Image" class="img-fluid"
                                    width="150" style="display: none; cursor: pointer;">
                            </div>
                        </div>
