                ...
                <div class="card-form" style="padding: 2rem;">
                    <form action="{{ route('information.article.update', $article->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="article_description" name="description" rows="4"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="special_information" name="special_information"
