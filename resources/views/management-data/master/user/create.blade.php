        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex flex-column">
                    <h4 class="mb-1 fw-normal" style="color: #1C3A6B;">Tambah User</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                            <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('user.data.index') }}">User</a></li>
                            <li class="breadcrumb-item" style="color: #023770">Tambah User</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-form" style="padding: 2rem;">
                <form action="{{ route('user.data.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('role') is-invalid @enderror" id="roles_id" name="role">
