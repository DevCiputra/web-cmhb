...
@section('title', 'Edit Soal Skrining')
...
<div class='dashboard-app'>
    ...
    <div class='dashboard-content'>
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex flex-column">
                    <h4 class="mb-1 fw-normal" style="color: #1C3A6B;">Edit Soal Skrining</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard-page') }}">Beranda</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('screening-depretion.index') }}">Soal Skrining</a></li>
                            <li class="breadcrumb-item" style="color: #023770">Edit Soal Skrining</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card" style="box-shadow: 4px 4px 24px 0px rgba(0, 0, 0, 0.04); border: none; border-radius: 12px;">
            <div class="card-form">
                <form action="{{ route('screening-depretion.update', $question->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-success" style="border-radius: 10px;">Simpan Perubahan</button>
                </form>
            </div>
        </div>
    </div>
