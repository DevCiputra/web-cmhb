        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex flex-column">
                    <h4 class="mb-1 fw-normal" style="color: #1C3A6B; font-weight:">Informasi RS</h4>
        ...
        <div class="card"
            ...
            <div class="card-body">
                <div class="d-flex mb-3">
                    ...
                    <div class="ms-auto">
                        <a href="/tambah_infors" style="text-decoration: none;">
                ...
                <div class="d-flex mb-4">
                    <p class="card-text">Berikut merupakan tabel data Informasi RS.</p>
                </div>
