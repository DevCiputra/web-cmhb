        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex flex-column">
                    <h4 class="mb-1 fw-normal" style="color: #1C3A6B; font-weight:">Edit Galeri RS</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                            <li class="breadcrumb-item"><a href=" ">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="/dashboard_galerirs">Galeri RS</a></li>
                            <li class="breadcrumb-item" style="color: #023770">Edit Galeri RS</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card" style="box-shadow: 4px 4px 24px 0px rgba(0, 0, 0, 0.04); border: none; border-radius: 12px; overflow: hidden; height: auto">
            <div class="card-body" style="padding: 2rem;">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="deskripsiPhoto" class="form-label">Deskripsi Photo</label>
                        <textarea class="form-control" id="deskripsiMCU" rows="4" placeholder="Masukkan Deskripsi Photo"></textarea>
                    </div>
