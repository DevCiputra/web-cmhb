...
<div class="row">
    @foreach ($promotions as $promotion)
        <!-- Memeriksa apakah kategori promo cocok dengan filter -->
        @if ($promotion->flag == request('flag') || request('flag') == '')
            <div class="col-md-4 promotion-item">
                <div class="promotion-content">
                    ...
                    @if ($promotion->media->isNotEmpty())
                        <img src="{{ $promotion->media->first()->file_url }}" alt="{{ $promotion->title }}"
                             class="img-fluid" data-bs-toggle="modal" data-bs-target="#imagePreviewModal"
