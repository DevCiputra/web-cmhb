    ...
    <div class="card" style="box-shadow: 4px 4px 24px 0px rgba(0, 0, 0, 0.04); border: none; border-radius: 12px; overflow: hidden; height: auto;">
        <div class="card-form" style="padding: 6rem;">
            ...
            <div class="mcu-info" style="margin-top: 2rem;">
                ...
                {!! $mcuService->special_information !!}

            </div>

            <div class="text-center" style="margin-top: 40px;">
                <a href="https://api.whatsapp.com/send?phone=6278033212250&text=Saya%20tertarik%20layanan%20di%20Ciputra%20Hospital%20saya%20ingin%20informasi%20mengenai {{ $mcuService->title }}" target="_blank" class="btn btn-reservation" style="background-color: #007858; color: white; border-color: #007858; border-radius: 18px; padding: 0.5rem 1rem; text-decoration: none;">
                    Reservasi Sekarang
                </a>
            </div>
        </div>
