...
Route::prefix('/doctor')->group(function () {
    Route::get('/', [LandingPageController::class, 'doctor'])->name('doctor.landing');
    Route::get('/profile/{id}', [LandingPageController::class, 'showDoctor'])->name('doctor.show.landing');
    Route::get('/search-doctor', [DoctorController::class, 'searchDoctor'])->name('doctor.search');
});

// MODUL MCU
Route::prefix('/medical-check-up')->group(function () {
    Route::get('/', [LandingPageController::class, 'medicalCheckUp'])->name('mcu.landing');
    Route::get('/detail/{id}', [LandingPageController::class, 'showMcuDetail'])->name('mcu.detail.landing');
});
